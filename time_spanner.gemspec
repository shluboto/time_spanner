...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Returns a time span splitted in desired units given two timestamps.}
  spec.summary       = %q{Returns a time span splitted in desired units given two timestamps.}
